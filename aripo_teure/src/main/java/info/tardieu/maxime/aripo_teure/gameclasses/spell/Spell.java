...
public class Spell extends AbstractSpell {
    ...
    public Spell(Spells name, int hitProbability, int damageWeak, int damage, int damageRange, String name_str, String description, Effect effect, int effectProbability) {
